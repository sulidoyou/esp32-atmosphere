...
#define APP_VERSION_STRING  _JOIN3(_STRINGIFY(APP_VERSION_MAJOR), _STRINGIFY(APP_VERSION_MINOR), _STRINGIFY(APP_VERSION_PATCH))
#define APP_VERSION_FULL    _JOIN4(_STRINGIFY(APP_VERSION_MAJOR), _STRINGIFY(APP_VERSION_MINOR), _STRINGIFY(APP_VERSION_PATCH), "0")
